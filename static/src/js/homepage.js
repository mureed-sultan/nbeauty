const branchData = {
  ...
  "Abu Dhabi - Mushrif Mall": {
    ...
    map: "https://maps.app.goo.gl/DwakU2F4Ndk6kjk67",
    phone: "+97124499783",
    whatsapp: "+97124499783",
  },
  "Abu Dhabi - Makani Al Shamkha": {
    address: "Makani Al Shamkha Mall, Abu Dhabi",
    map: "https://maps.app.goo.gl/a3Zypkf3EaP2Rtu96",
    phone: "+97125848711",
    whatsapp: "+97125848711",
  },
  "Abu Dhabi - Bawabat Al Sharq": {
    address: "Bawabat Al Sharq Mall, Abu Dhabi",
    map: "https://maps.app.goo.gl/DpL49X8F7BDQtyMD6",
    phone: "+97125864027",
    whatsapp: "+97125864027",
  },
  "Abu Dhabi - Dalma Mall": {
    address: "Dalma Mall, Abu Dhabi",
    map: "https://maps.app.goo.gl/qpXLTDsfpc9dJK8k9",
    phone: "+97124436720",
    whatsapp: "+97124436720",
  },
  "Ras Al Khaimah - Al Naeem City Center": {
    address: "Al Naeem City Center, Ras Al Khaimah",
    map: "https://www.google.com/search?sca_esv=feadb363bafe7c19&hl=en&authuser=8&sxsrf=AHTn8zqCMtqDyiyxKP_-bS0o66Ne7naU5w:1746181132884&kgmid=/g/11x7rg6bl5&q=N+Beauty+Salon+%7C+Best+Beauty+Salon&shndl=30&shem=lcuae,uaasie&source=sh/x/loc/uni/m1/1&kgs=aa78568f3cca54f8",
    phone: "+97172359145",
    whatsapp: "+97172359145",
  },
  "Ras Al Khaimah - Al Naeem Mall": {
    address: "Al Naeem Mall, Ras Al Khaimah",
    map: "https://maps.app.goo.gl/9wdxP3FcTtuixxfo7",
    phone: "+97172267540",
    whatsapp: "+97172267540",
  },
  "Ras Al Khaimah - My City Centre Al Dhait": {
    address: "My City Centre Al Dhait, Ras Al Khaimah",
    map: "https://maps.app.goo.gl/S4T7j33dygmrAF8w8",
    phone: "+97172214172",
    whatsapp: "+97172214172",
  },
  "Ras Al Khaimah - Manar Mall": {
    address: "Manar Mall, Ras Al Khaimah",
    map: "https://maps.app.goo.gl/9phQUiRjL6HZUxEK9",
    phone: "+971542722555",
    whatsapp: "+971542722555",
  },
  "Ajman - City Life Al Jurf": {
    address: "City Life, Al Jurf, Ajman",
    map: "https://maps.app.goo.gl/QvoiHpNcHginVKpB9",
    phone: "+97167317772",
    whatsapp: "+97167317772",
  },
  "Ajman - Radisson Blu Toombal": {
    address: "Radisson Blu Hotel, Ajman",
    map: "https://www.google.com/search?sca_esv=613adaf9b5e05094&sxsrf=AHTn8zpGrX4MKbSHqjFo38Aka2TI5D8zKw:1746171078025&kgmid=/g/11r6sbvcpk&q=The+One+%26+Only+Madhu+Beauty+Lounge+%7C+Best+Facial+in+UAE&shndl=30&shem=lcuae,uaasie&source=sh/x/loc/uni/m1/1&kgs=96dba441718cb88c",
    phone: "+971586403251",
    whatsapp: "+971586403251",
  },
  "Fujairah - Lulu Mall": {
    address: "Lulu Mall, Fujairah",
    map: "https://maps.app.goo.gl/XppunjPNDU4NUrdF8",
    phone: "+97192237635",
...
function updateLocation(value) {
  ...
  // ✅ Phone 1
  const call1 = document.getElementById("call-btn");
  call1.href = "tel:" + data.phone;
  call1.textContent = data.phone;

  // ✅ Phone 2 (optional second number)
  const call2 = document.getElementById("call-btn-2");
  if (data.whatsapp) {
    call2.href = "tel:" + data.whatsapp;
    call2.textContent = data.whatsapp;
    call2.style.display = "inline-block";
  } else {
